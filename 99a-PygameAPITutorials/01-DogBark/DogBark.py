...
def main():
    ...
    while True:
        ...
        caption2 = font2.render("I did not slap you", True, WHITE)
        caption3 = font3.render("I high fived your face!", True, WHITE)
        ...
        screen.blit(caption3, ((image1.get_width() // 2) - (caption2.get_width() // 2), image1.get_height() - caption3.get_height()))
