...
def problem1(square, thickness, window):
    ...
    circ_center = rg.Point(center.x, center.y + length)
    midpoint = rg.Point(center.x - (length // 2), center.y)
    circle = rg.Circle(circ_center, (length // 2))
    circle.fill_color = square.fill_color
    circle.outline_thickness = thickness
    circle.attach_to(window)
    line = rg.Line(midpoint, circ_center)
