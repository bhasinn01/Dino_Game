...
def main():
    ...
    #better_draw_circles(100, 50, 15)
    #better_draw_circles(-200, 0, 3)
    #even_better_draw_circles(100, 50, 15, 15, "blue", 5)
    #even_better_draw_circles(-200, 0, 3, 5, "red", 1)
    even_better_draw_circles(0, 0, 15, 5, "black", 5)
    even_better_draw_circles(125, 125, 100, 1, "blue", 5)
    even_better_draw_circles(-125, -125, 100, 1, "green", 5)
    even_better_draw_circles(125, -125, 100, 1, "red", 5)
    even_better_draw_circles(-125, 125, 100, 1, "orange", 5)
    even_better_draw_circles(127, 127, 15, 3, "orange", 5)
    even_better_draw_circles(-127, -127, 15, 3, "red", 5)
    even_better_draw_circles(127, -127, 15, 3, "blue", 5)
    even_better_draw_circles(-127, 127, 15, 3, "green", 5)
...
###############################################################################
def better_draw_circles(cor_x, cor_y, radii):
    """
    ...
    turtle = rg.SimpleTurtle()
    turtle.pen_up()
    turtle.go_to(rg.Point(cor_x, cor_y))
    turtle.set_heading(0)  # Point "east" (towards the right)
...
###############################################################################
def even_better_draw_circles(cor_x, cor_y, radii, c, color, thickness):
