...
#                clone   move_center_to   move_by
#  +
#          -- Write the names of three INSTANCE VARIABLEs that Circle
#             objects have:
#                fill_color   outline_thickness   radius center
#  _
#     f. What does a RoseWindow RENDER method do?
#            Makes the attached graphical objects appear on the screen.
#             Useful for Animation.
#  _
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            Without it the program would end and the graphics would go away before we could see it
#  _
